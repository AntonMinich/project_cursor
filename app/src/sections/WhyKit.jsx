...
export default function WhyKit() {
  return (
    <section id="why-kit" className="relative min-h-svh overflow-hidden">
      ...
      <div className="relative z-10 mx-auto flex min-h-svh max-w-[1320px] items-center px-6 py-28 md:px-10">
        <div>
          <Reveal>
